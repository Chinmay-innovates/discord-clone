    ...
    return (
        ...
        >
                ...
                <div className="ml-auto flex items-center gap-x-2">
                    <ActionTooltip label="Edit">
                        <Edit
                            ...
                            className="hidden group-hover:block size-4 text-zinc-500 hover:text-zinc-600 dark:text-zinc-400  dark:hover:text-zinc-600 transition" />
                    </ActionTooltip>
            ...
            {channel.name === "general" && (
                <Lock className="size-4 text-zinc-500 dark:text-zinc-400 ml-auto" />
            )}
        </button>
